...
/** Gear — the Settings header button. */
...
/** Wrench — the Maintenance header button. */
export const WrenchIcon: Component<IconProps> = (p) => (
  <svg {...strokedSvgProps(p)}>
...
/** Eye — a recipe visible on the Home picker. */
export const EyeIcon: Component<IconProps> = (p) => (
  <svg {...strokedSvgProps(p)}>
...
/** Eye with a slash — a recipe hidden from the Home picker. */
export const EyeOffIcon: Component<IconProps> = (p) => (
  <svg {...strokedSvgProps(p)}>
...
/** Trash can — the shot-detail Delete action. */
...
/** Pencil — the shot-detail Edit toggle. */
export const PencilIcon: Component<IconProps> = (p) => (
  <svg {...strokedSvgProps(p)}>
    <path d="M12 20h9" />
